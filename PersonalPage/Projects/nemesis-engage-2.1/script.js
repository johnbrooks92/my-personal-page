...
$('body').keydown(function (event) {
    ...
    if (inputCode == beginCode) {
        ...
        setTimeout(function () {
            $('#startupScreen').css('background-image', 'url(img/montage/ben-kenobi.gif');
        }, 29500);
        setTimeout(function () {
        ...
        setTimeout(function () {
            $('#startupScreen').css('background-image', 'url(img/montage/Megumi_vs._Sukuna.webp');
        }, 72000);
        setTimeout(function () {
...
const rosterObject = {
    "fighters": [
        ...
        {
            "name": "Gojo",
            "moves": ["Convergence", "Hollow Purple", "Infinity"],
            "ultimate": "Domain Expansion",
            "transformations": "Young, Sensei, TBD",
        ...
        {
            "name": "Fushiguro",
            "moves": ["Orochi", "Nue", "Demon Dogs"],
            "ultimate": "Domain Expansion",
            "transformations": "JJK, Zenin, TBD",
            "series": "Jujutsu Kaisen",
            "img": "img/megumi.png",
            "unlock": "no",
            "rivals": "Itadori",
        ...
        {
            "name": "Itadori",
            "moves": ["Divergent Fist", "Sukuna Fingers", "Besto Friendo"],
            "ultimate": "Domain Expansion",
            "transformations": "Itadori, Sukuna, TBD",
            "series": "Jujutsu Kaisen",
            "img": "img/itadori.webp",
            "unlock": "no",
            "rivals": "Gojo, Fushiguro",
            "atk": 33,
            "defend": 35,
            "speed": 34,
            "atkaura": 23,
...
//Adding toggle for selecting 2nd character
    ...
    $(document).ready(function () {
        ...
        if (res.series == "Jujutsu Kaisen") {
            $('.Jujutsu').css('background-image', 'url(img/jjk-bg.jpeg');
            $('.Jujutsu').css('background-size', 'cover');
        }
        ...
        $("#" + res.id + "charSelectBtn1").click(function () {
            ...
            $('#p1Move1').click(function () {
                if ((p1Move1Selection == "Rasengan" || "Chidori" || "Kamehameha" || "Galick Gun" || "Force Push" || "Force Choke" || "Death Beam" || "Lightning Blade" || "Spirit Gun" || "Spirit Sword" || "Heaven-Piercing Ice Wall" || "Convergence") && (p1KiTotals >= 250)) {
                ...
                } else if ((p1Move1Selection == "Krypton Rush" || "Omni-Style Rush" || "Full Force Punch" || "Metal Mash" || "Tornado Fist" || "Scream's Rage" || "Rose Whip" || "Speed Slice" || "New Hampshire Smash" || "Explosive Punch" || "Cane Hook Slash" || "Clone Explosion Jutsu" || "Barrage of Arrows" || "Samurai Slashing" || "Scarabs Scurrying" || "ODM Gear" || "Fissure Kick" || "Orochi" || "Divergent Fist") && (p1KiTotals >= 250)) {
            ...
            $('#p1Move2').click(function () {
                if ((p1Move2Selection == "Uzumaki Barrage" || "Barrage of Lions" || "Dragon Fist" || "Batarang" || "Star Saber" || "Nova Strike" || "G Force Punch" || "Spirit Gun Fist" | "Spirit Kick" || "Fist of the Mortal Flame" || "Detroit Smash" || "Explosive Kick" || "Boomerang Bash" || "Speed Slice" || "Demonic Dash" || "Attack Titan" || "Nue") && (p1KiTotals >= 325)) {
                ...
                } else if ((p1Move2Selection == "Dirty Fireworks" || "Heat Vision" || "Force Throw" || "Force Lightning" || "Requiem Blaster" || "Earth Style: Mud Wall" || "Seed of the Death Plant" || "Wall of Flames" || "Bentley's Brave Byte" || "Tsukuyomi" || "Crimson Ball Wave" || "Hollow Purple" || "Sukuna Fingers") && (p1KiTotals >= 325)) {
            ...
            $('#p1Move3').click(function () {
                if ((p1Move3Selection == "Toad Summoning" || "Snake Summoning" || "Ice Breath" || "Mind Trick" || "Death Wave" || "Force Choke" || "Spirit Wave" || "Spirit Sword Javelin" || "Sword of Darkness Flame" || "Black Whip" || "Reverse Explosion" || "Flashfreeze Heatwave" || "Amaterasu" || "Eye Beams" || "WarHammer Titan" || "Infinity") && (p1KiTotals >= 750)) {
                    ...
                    p1UniqueSpd += p1SpdCounter;
                    player1TurnCounter += 1;
                } else if ((p1Move3Selection == "Kaioken Triple Attack" || "Infinite Break" || "Cape Cover" || "Lightsaber Boomerang" || "Skyboom Shield" || "Primary Lotus" || "Afterimage" || "Ojigi Plant" || "Murray's Manhandling" || "Saber Slash" || "Bomb-Slash Combo" || "Parry" || "Sacred Energy Armor" || "Demon Dogs" || "Besto Friendo") && (p1KiTotals >= 750)) {
            ...
            $('#p1MoveUlt').click(function () {
                if ((p1MoveUltSelection == "RasenShuriken" || "Kirin" || "Spirit Bomb" || "Final Flash" || "Solar Flare" || "Mega Melting" || "Death Ball" || "Kamui" || "SuperNova Fireworks" || "Mazoku Spirit Gun" || "Dimension Sword" || "Sinning Tree" || "Dragon of the Darkness Flame" || "Flashfire Fist - Jet Kindling" || "Susanoo" || "Necromancy" || "Sacred Energy Beam" || "Domain Expansion") && (p1KiTotals >= 1000)) {
            ...
            $('#p2Move1').click(function () {
                ...
                if ((p2Move1Selection == "Rasengan" || "Chidori" || "Kamehameha" || "Galick Gun" || "Force Push" || "Force Choke" || "Death Beam" || "Lightning Blade" || "Spirit Gun" || "Spirit Sword" || "Heaven-Piercing Ice Wall" || "Convergence") && (p2KiTotals >= 250)) {
                ...
                } else if ((p2Move1Selection == "Krypton Rush" || "Omni-Style Rush" || "Full Force Punch" || "Metal Mash" || "Tornado Fist" || "Scream's Rage" || "Rose Whip" || "Speed Slice" || "New Hampshire Smash" || "Explosive Punch" || "Cane Hook Slash" || "Clone Explosion Jutsu" || "Barrage of Arrows" || "Samurai Slashing" || "Scarabs Scurrying" || "ODM Gear" || "Fissure Kick" || "Orochi" || "Divergent Fist") && (p2KiTotals >= 250)) {
            ...
            $('#p2Move2').click(function () {
                ...
                if ((p2Move2Selection == "Uzumaki Barrage" || "Barrage of Lions" || "Dragon Fist" || "Batarang" || "Star Saber" || "Nova Strike" || "G Force Punch" || "Spirit Gun Fist" | "Spirit Kick" || "Fist of the Mortal Flame" || "Detroit Smash" || "Explosive Kick" || "Boomerang Bash" || "Speed Slice" || "Demonic Dash" || "Attack Titan" || "Nue") && (p2KiTotals > 325)) {
                    ...
                    p1AuraDefDiv.textContent = 'Aura Defense: ' + newP1AuraDef;
                    p1SpdDiv.textContent = 'Speed: ' + newP1Spd;
                } else if ((p2Move2Selection == "Dirty Fireworks" || "Heat Vision" || "Force Throw" || "Force Lightning" || "Requiem Blaster" || "Earth Style: Mud Wall" || "Seed of the Death Plant" || "Wall of Flames" || "Bentley's Brave Byte" || "Tsukuyomi" || "Crimson Ball Wave" || "Hollow Purple" || "Sukuna Fingers") && (p2KiTotals > 325)) {
            ...
            $('#p2Move3').click(function () {
                ...
                if ((p2Move3Selection == "Toad Summoning" || "Snake Summoning" || "Ice Breath" || "Mind Trick" || "Death Wave" || "Force Choke" || "Spirit Wave" || "Spirit Sword Javelin" || "Sword of Darkness Flame" || "Black Whip" || "Reverse Explosion" || "Flashfreeze Heatwave" || "Amaterasu" || "Eye Beams" || "WarHammer Titan" || "Infinity") && (p2KiTotals >= 750)) {
                    ...
                    p1AuraDefDiv.textContent = 'Aura Defense: ' + newP1AuraDef;
                    p1SpdDiv.textContent = 'Speed: ' + newP1Spd;
                } else if ((p2Move3Selection == "Kaioken Triple Attack" || "Infinite Break" || "Cape Cover" || "Lightsaber Boomerang" || "Skyboom Shield" || "Primary Lotus" || "Afterimage" || "Ojigi Plant" || "Murray's Manhandling" || "Saber Slash" || "Bomb-Slash Combo" || "Parry" || "Sacred Energy Armor" || "Demon Dogs" || "Besto Friendo") && (p2KiTotals >= 750)) {
            ...
            $('#p2MoveUlt').click(function () {
                ...
                if ((p2MoveUltSelection == "RasenShuriken" || "Kirin" || "Spirit Bomb" || "Final Flash" || "Solar Flare" || "Mega Melting" || "Death Ball" || "Kamui" || "SuperNova Fireworks" || "Mazoku Spirit Gun" || "Dimension Sword" || "Sinning Tree" || "Dragon of the Darkness Flame" || "Flashfire Fist - Jet Kindling" || "Susanoo" || "Necromancy" || "Sacred Energy Beam" || "Domain Expansion") && (p2KiTotals >= 1000)) {
        ...
        $('#charSelectBtn2' + res.id).click(function () {
            ...
            setTimeout(function () {
                if ((player1TurnCounter == player2TurnCounter) && (rosterObject.fighters[p1Uniqueid - 1].speed > rosterObject.fighters[p2Uniqueid - 1].speed)) {
                    overallTurnCounter += 1;
                    var textBoxDiv = document.getElementById('textBox');
                    textBoxDiv.innerHTML += "- You begin with 1200/1200 HP and 600/1200 Ki. <br>- Remember speed checks are done behind the screen each turn and buttons should toggle appropriately. <br>- Home player gets the tiebreaker on speed. <br>" + "Ki Consumption <br>" + "Move 1: 250ki<br>" + "Move 2: 325ki<br>" + "Move 3: 750ki<br>" + "Move 4: 1000ki<br>" + "Turn #" + overallTurnCounter + ". " + rosterObject.fighters[p1Uniqueid - 1].name + " is first this turn. <br>";
                    document.getElementById('battle1').style.pointerEvents = 'auto';
                    document.getElementById('battle2').style.pointerEvents = 'none';
            ...
            $(document).ready(function () {
                ...
                if (res.series == "Jujutsu Kaisen") {
                    ...
                    // $('#battle2').css('background-size', 'cover');
                    $('#battleScreen').css('background-image', 'url(img/jjk-scene.jpeg');
                    $('#battleScreen').css('background-size', 'cover');
                }
                //Speed Check
